...
floating-keypad spin entry with Even-Money, 12-Number, 4-Streets, and Freddy's
...
Local-first European roulette dashboard with live strategy tracking,
backtesting, floating quick entry, recovery archives, and optional
completed-session Google Sheets sync.
